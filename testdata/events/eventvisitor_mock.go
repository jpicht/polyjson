...
// Source: github.com/jpicht/polyjson/testdata/events (interfaces: EventVisitor)
//
// Generated by this command:
//
//	mockgen -package events -destination eventvisitor_mock.go . EventVisitor
//
...
// VisitUpdateAttendance mocks base method.
func (m *MockEventVisitor) VisitUpdateAttendance(arg0 UpdateAttendance) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "VisitUpdateAttendance", arg0)
}

// VisitUpdateAttendance indicates an expected call of VisitUpdateAttendance.
func (mr *MockEventVisitorMockRecorder) VisitUpdateAttendance(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VisitUpdateAttendance", reflect.TypeOf((*MockEventVisitor)(nil).VisitUpdateAttendance), arg0)
}
